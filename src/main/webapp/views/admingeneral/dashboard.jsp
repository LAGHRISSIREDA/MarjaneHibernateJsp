      ...
      <nav class="mt-5 flex-1 flex flex-col divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
        ...
        <div class="mt-6 pt-6">
          <div class="px-2 space-y-1">
            ...
            <a href="logout.general" class="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-cyan-100 hover:text-white hover:bg-cyan-600">
              ...
              <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="create.general" method="post">
                      <div>
                      ...
                      <div>
                        ...
                        <select name="center" id="center" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" ${center.size()==null?"disabled":""} >
                          <c:forEach items="${center}" var="c">
                            <c:choose>
                              <c:when test="${c.dispo}">
        ...
        <div class="hidden sm:block">
          ...
          <c:forEach items="${admins}" var="t">
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                      ...
                      <td class="py-3 px-6 text-center">
                        <span class=font-medium">${t.center.nom}, ${t.center.ville}</span>
                      </td>
                      <td class="py-3 px-6 text-center">
